...
public class CreateFoodAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   //doGet(request, response);
		...
		inventory.add(new FoodEntries(id,name,request.getParameter("description"),request.getParameter("foodimageURL"),Double.parseDouble(request.getParameter("price"))));
		request.setAttribute("inventory", inventory);
